  ...
  const exercises = [
    {
      ...
      video: (
        <iframe
          className="exercise-yt-videos"
          width="560"
          height="315"
          src="https://www.youtube.com/embed/9XWLM49qZvM?si=_y6T_p6MSniBItCV"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/crk9ZzNAG_Q?si=HrfSXMTNOLy4eeNt"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/WG3vdcq__I0?si=sDLva2ZH4FZeKDWe"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/OPqe0kCxmR8?si=vhud3LSKqgA6_H5o"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/kwG2ipFRgfo?si=NNYXEAXtDtTEm4BD"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/ZrpRBgswtHs?si=Kjlg9TbToYWkd7X1"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/HtiY7tWu96s?si=vSKUTMDqS24rDwpE"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/VMbDQ8PZazY?si=PLeHgzN5K64ynjBc"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
    ...
    },
    {
      ...
      video: (
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/zFiQuXeFEuI?si=9zjkzDQG26eH-my8"
          title="YouTube video player"
          frameborder="0"
          allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
          referrerpolicy="strict-origin-when-cross-origin"
            ...
            <div key={index} className="exercise-card">
              <div className="exercise-details">
                ...
                <p className="exercise-description">
                  Type :{" "}
                  <span className="exercise-minors">
                    <b>{exercise.type}</b>
                  </span>
                </p>
                <p className="exercise-description">
              ...
              <div className="exercises-video">{exercise.video}</div>
            </div>
          ))}
        </div>
      </div>
